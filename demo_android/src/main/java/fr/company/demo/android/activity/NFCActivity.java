...

{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        // usage: setNdefPushMessageCallback( callback, activity, optionalExtraActivities) 
        ...
        try
        {
            ndefDetected.addDataType("app/fr.nfcdemo"); //app/fr.ippon.nfcdemo
    ...
    protected void onResume()
    {
        ...
        //mNfcAdapter.enableForegroundNdefPush( this, createNdefFromJson());
        mNfcAdapter.setNdefPushMessage(createNdefFromJson(), this);
    ...
    private void setTextFieldValues(String jsonString)
    {
        ...
        try
        {
            ...
            name = inventory.getString("n"); // name
            ram = inventory.getString("r"); // ram
            processor = inventory.getString("p"); // processor
    ...
    private TextWatcher mTextWatcher = new TextWatcher()
    {
        ...
        public void afterTextChanged(Editable arg0)
        {
            // if (mResumed)
            // {
            //mNfcAdapter.enableForegroundNdefPush(NFCInventoryActivity.this, createNdefFromJson());
            mNfcAdapter.setNdefPushMessage(createNdefFromJson(), NFCActivity.this);
            // }
        }
    };
