...
<body>
	...
	<!-- Internal Scripts -->
	<script type="text/javascript" src="/superviseur-mobile/js/html5.js" /></script>
	<script type="text/javascript" src="/superviseur-mobile/js/vendor/zepto.min.js" /></script>
	<script type="text/javascript" src="/superviseur-mobile/js/jquery/jquery-1.8.2.js" /></script>
	<script type="text/javascript" src="/superviseur-mobile/js/bootstrap/bootstrap.min.js" /></script>
